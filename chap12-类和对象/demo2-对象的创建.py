...
'''print(id(stu1))#2311840556720
print(type(stu1))   #<class 'type'>
print(stu1)     #<__main__.Student object at 0x0000026722516E00>
print('------------------------')
...
# 2
Student.info(stu1)#类名.方法名（类的对象）-->方法定义的self
#54行和51是相同功能 都是调用Student的info功能
